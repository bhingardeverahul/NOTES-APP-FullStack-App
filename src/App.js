...
function App() {
  ...
  const getAllnotes = async () => {
    try {
      const response = await fetch(`https://apibackend-hgvf.onrender.com/getallnotes`, {
        method: "GET",
        headers: {
  ...
  const Addnotes = async (title, desc, tag) => {
    try {
      const response = await fetch(` https://apibackend-hgvf.onrender.com/addnotes`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          // 'Content-Type': 'application/x-www-form-urlencoded',
  ...
  const Delete = async (id) => {
    try {
      const response = await fetch(` https://apibackend-hgvf.onrender.com/delete/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          // 'Content-Type': 'application/x-www-form-urlencoded',
  ...
  const Edit = async (id, title, desc, tag) => {
    const response = await fetch(` https://apibackend-hgvf.onrender.com/edit/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        // 'Content-Type': 'application/x-www-form-urlencoded',
